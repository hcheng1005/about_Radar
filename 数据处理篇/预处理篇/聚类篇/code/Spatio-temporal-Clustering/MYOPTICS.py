...
def OPTICS(data,eps=np.inf,minPts=15):
    ...
    for pointId in core_points_index:
        ...
        if (isProcess[pointId] == -1):
            ...
            reach_dists[pointId] = core_dists[pointId]
...
data = np.loadtxt("/home/zdhjs-05/myGitHubCode/about_Radar/数据处理篇/预处理篇/聚类篇/code/Spatio-temporal-Clustering/data/cluster.csv", delimiter=",")

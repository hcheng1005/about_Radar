...
| [代码实战：ECG分类](./ECG5000/ECG_Classification.ipynb)  | 分别使用SVM和MLP对信号分类 |  |
| [自定义数据集并使用CNN模型](./CNN_/CNN_customData.ipynb) |  |  |
| [CNN](./CNN_/CNN.ipynb) | 使用pytorch实现简单的CNN网络进行手写数字识别 <br> 模型参数量统计| [CNN_colab](https://colab.research.google.com/drive/1YZ0FYbkyMR1HoVW67sLcsYN_TdavNLRp#scrollTo=KJE4QNdHqh0f) |
| [LSTM](./LSTM_/LSTM_demo.ipynb) | 包含LSTM模型训练、参数提取和C代码部署 | [C code](./LSTM_/lstm.c)|
